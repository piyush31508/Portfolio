    ...
    >
      <div className="container max-w-4xl mx-auto text-center z-10">
        <div className="space-y-6">
          ...
          >
            Hi, I'm{" "}
            <span className="text-primary">Piyush</span>
            <span className="text-gradient ml-2">Chawla</span>
          </motion.h1>
          ...
          >
            I’m a Full Stack Developer passionate about building elegant and fast web apps with MERN Stack and Spring Boot. Let’s build something amazing together!
          </motion.p>
