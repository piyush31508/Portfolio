...
const skills = [
  ...
  { name: "Vite.js", level: 85, category: "frontend" },
  ...
  { name: "JWT Auth", level: 88, category: "concepts" },
  { name: "SEO Optimization", level: 80, category: "concepts" },
  { name: "Responsive Design", level: 92, category: "concepts" },
];

const categories = ["frontend", "backend", "database", "tools", "concepts"];
...
export const SkillsSection = () => {
  ...
  return (
    <section
      id="skills"
      className="py-24 px-4 relative bg-gradient-to-br from-muted/50 to-background"
    >
